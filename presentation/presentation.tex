...
\frame{
  ...
  \begin{itemize}
    ...
    \item optimized using Adam TODO: add citation
    \item used dropout (0.5) and weight decay (0.01) for regularization TODO: add citatoin
    \item trained for 200 epochs
  \end{itemize}
}
